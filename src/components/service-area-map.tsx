        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2 items-center">
          <div className="rounded-xl overflow-hidden border border-white/10 h-[400px]">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20800!2d-124.8055!3d49.2338!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5488a45314241e1d%3A0x50135152a7b0fd0!2sPort%20Alberni%2C%20BC%2C%20Canada!5e0!3m2!1sen!2sca!4v1"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
